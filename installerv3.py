...
yellow='\033[33;1m'
###################################################
# Channel Wolf Xploiter Team 999
###################################################
trap ctrl_c INT
ctrl_c() {
clear
...
sleep 1
echo ""
echo  $white"[#]> RakhaGans07
Here ... "
read enter
exit
}
=================================================
echo $white"Author : RakhaGans07"
echo $white"Team : Wolf Xploiter Team 999"
echo $white"Thanks To :AND ALL FRIENDS "
echo $white"Thanks To :CREATOR MCJI"
echo $white"thanks To : WOLF CYBER ARMY"
echo $white"thanks To : JAWA BARAT CYBER"
echo $white"thanks To : ALL TEAM HACKER INDO"
